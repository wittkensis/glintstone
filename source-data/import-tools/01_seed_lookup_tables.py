...
PROVENIENCE_REGIONS: dict[tuple[str, str], list[str]] = {
    ...
    ("Northern Mesopotamia", "Upper Mesopotamia"): [
        "Tell Brak",
        "Chagar Bazar",
        "Tell Mozan",
        "Tell Leilan",
...
PROVENIENCE_DIRECT: dict[str, tuple[str, str]] = {
    # Southern Mesopotamia > Central
    "Puzriš-Dagan": ("Southern Mesopotamia", "Central"),
    "Irisagrig": ("Southern Mesopotamia", "Central"),
    "Irisaĝrig": ("Southern Mesopotamia", "Central"),
    "Du-Enlila": ("Southern Mesopotamia", "Central"),
    "Kesh": ("Southern Mesopotamia", "Central"),
    "Sagub": ("Southern Mesopotamia", "Central"),
    "Gišša": ("Southern Mesopotamia", "Central"),
    "Gišši": ("Southern Mesopotamia", "Central"),
    "Maškan-šapir": ("Southern Mesopotamia", "Central"),
    # Southern Mesopotamia > Akkad
    "Bābili": ("Southern Mesopotamia", "Akkad"),
    "Ešnunna": ("Southern Mesopotamia", "Akkad"),
    "Šaduppum": ("Southern Mesopotamia", "Akkad"),
    "Nerebtum": ("Southern Mesopotamia", "Akkad"),
    "Dūr-Abī-ēšuḫ": ("Southern Mesopotamia", "Akkad"),
    "Lagaba": ("Southern Mesopotamia", "Akkad"),
    "Kutalla": ("Southern Mesopotamia", "Akkad"),
    "Sirara": ("Southern Mesopotamia", "Akkad"),
    "Ālu-ša-Našar": ("Southern Mesopotamia", "Akkad"),
    "Ma'allanate": ("Southern Mesopotamia", "Akkad"),
    "Kazallu": ("Southern Mesopotamia", "Akkad"),
    "Der": ("Southern Mesopotamia", "Akkad"),
    "Upi": ("Southern Mesopotamia", "Akkad"),
    "Malgium (Tell Yassir)": ("Southern Mesopotamia", "Akkad"),
    "Āl-šarri": ("Southern Mesopotamia", "Akkad"),
    "Dur-Kurigalzu": ("Southern Mesopotamia", "Akkad"),
    "Bit-šar-Babili": ("Southern Mesopotamia", "Akkad"),
    "Bīt-Abī-rām": ("Southern Mesopotamia", "Akkad"),
    "Bīt-Bāba-ēriš": ("Southern Mesopotamia", "Akkad"),
    "Bīt-Naʾinnašu": ("Southern Mesopotamia", "Akkad"),
    "Bīt-Dibušiti": ("Southern Mesopotamia", "Akkad"),
    "Bīt-Ṭāb-Bēl": ("Southern Mesopotamia", "Akkad"),
    "Bīt-Šinqā": ("Southern Mesopotamia", "Akkad"),
    "Bīt-ham...": ("Southern Mesopotamia", "Akkad"),
    "Bīt-Našar": ("Southern Mesopotamia", "Akkad"),
    "Ālu-ša-Ṭūb-Yāma": ("Southern Mesopotamia", "Akkad"),
    "Alu-šabtu": ("Southern Mesopotamia", "Akkad"),
    "Alu-ša-šuma-ukin": ("Southern Mesopotamia", "Akkad"),
    "Alu-eššu": ("Southern Mesopotamia", "Akkad"),
    "Alu-binatu": ("Southern Mesopotamia", "Akkad"),
    "Alu-ša-BAD-MAH-AN": ("Southern Mesopotamia", "Akkad"),
    "Āl-šarri-ša-qašti-eššeti": ("Southern Mesopotamia", "Akkad"),
    "Bit-ali-...": ("Southern Mesopotamia", "Akkad"),
    "Bit-zerija": ("Southern Mesopotamia", "Akkad"),
    "Bit-Šaḫṭu": ("Southern Mesopotamia", "Akkad"),
    "Bit-ḫulummu": ("Southern Mesopotamia", "Akkad"),
    "Bāb-ṣubbāti": ("Southern Mesopotamia", "Akkad"),
    "Ba-milkišu": ("Southern Mesopotamia", "Akkad"),
    "Kapri-ša-naqidati": ("Southern Mesopotamia", "Akkad"),
    "Kapru": ("Southern Mesopotamia", "Akkad"),
    "Pašime": ("Southern Mesopotamia", "Akkad"),
    "Naṣir": ("Southern Mesopotamia", "Akkad"),
    "Naḫalla": ("Southern Mesopotamia", "Akkad"),
    "Dusabar": ("Southern Mesopotamia", "Akkad"),
    "Kumu": ("Southern Mesopotamia", "Akkad"),
    "KI.AN": ("Southern Mesopotamia", "Akkad"),
    "GARIN-naḫallum": ("Southern Mesopotamia", "Akkad"),
    # Southern Mesopotamia > Sumer
    "Garšana": ("Southern Mesopotamia", "Sumer"),
    "Pī-Kasî": ("Southern Mesopotamia", "Sumer"),
    "Girigu": ("Southern Mesopotamia", "Sumer"),
    # Southern Mesopotamia > Sealand
    "Dūr-Enlilē": ("Southern Mesopotamia", "Sealand"),
    # Northern Mesopotamia > Assyria
    "Šibaniba": ("Northern Mesopotamia", "Assyria"),
    "Tarbisu": ("Northern Mesopotamia", "Assyria"),
    "Tushhan": ("Northern Mesopotamia", "Assyria"),
    "Kilizu": ("Northern Mesopotamia", "Assyria"),
    "Ḫadatu": ("Northern Mesopotamia", "Assyria"),
    "Apqu-ša-Adad": ("Northern Mesopotamia", "Assyria"),
    "Tabetu": ("Northern Mesopotamia", "Assyria"),
    "Šaddikanni": ("Northern Mesopotamia", "Assyria"),
    "Til Barsip": ("Northern Mesopotamia", "Assyria"),
    "Marqasu": ("Northern Mesopotamia", "Assyria"),
    "Kar-bel-matati": ("Northern Mesopotamia", "Assyria"),
    "Kar-Mullissu": ("Northern Mesopotamia", "Assyria"),
    "Kar-Nabu": ("Northern Mesopotamia", "Assyria"),
    "Ḫadiranu-ša-Nabu": ("Northern Mesopotamia", "Assyria"),
    "Idu": ("Northern Mesopotamia", "Assyria"),
    # Northern Mesopotamia > Upper Mesopotamia
    "Nagar": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Šubat-Enlil": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Ašnakkum": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Qattara": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Ḫarbe": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Kahat": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Tigunānum": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Mardaman": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Baḫe": ("Northern Mesopotamia", "Upper Mesopotamia"),
    "Udannu": ("Northern Mesopotamia", "Upper Mesopotamia"),
    # Anatolia
    "Ḫattusa": ("Anatolia", ""),
    "Šapinuwa": ("Anatolia", ""),
    "Melidu": ("Anatolia", ""),
