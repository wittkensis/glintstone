---
question: "How do BabyLemmatizer, DETR, Akkademia, and other ML models integrate into Glintstone's schema and pipeline?"
created: 2026-05-11
modified: 2026-05-11
context: "Captures the patterns for storing ML annotations as first-class annotation runs (with confidence, model version, source) alongside human annotations. Models live in ml/service/; this doc explains how their outputs land in the data model."
status: active
audience: [engineers]
owners: [eric]
related_issues: []
