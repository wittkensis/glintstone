---
question: "What does each upstream source (CDLI, ORACC, eBL, ePSD2, OGSL, …) provide, under what license, and via what access method?"
created: 2026-05-11
modified: 2026-05-11
context: "The read-side catalog: per-source license, access method, field mappings, freshness. Operationally companion to gs-expert-integrations/sources.md (the write-side per-source quirks for connectors)."
status: active
audience: [engineers]
owners: [eric]
related_issues: []
...
For field-level source mappings, see [source-mapping.yaml](source-mapping.yaml).
