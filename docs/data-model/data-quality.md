---
question: "How does Glintstone's schema express academic trust, source attribution, and competing scholarly interpretations?"
created: 2026-05-11
modified: 2026-05-11
context: "Captures the trust architecture and provenance design that makes Glintstone a credible reference for working scholars. Every annotation table carries annotation_run_id; competing interpretations are stored, not deduplicated."
status: active
audience: [engineers]
owners: [eric]
related_issues: []
...
12 critical data issues were identified by testing the schema against the live 314 MB database (389,715 artifacts). All are addressed in the design. See [data-issues.md](data-issues.md) for the full catalog.
