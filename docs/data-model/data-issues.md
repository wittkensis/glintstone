---
question: "What known data-quality issues exist in the corpus, and how does the schema address each one?"
created: 2026-05-11
modified: 2026-05-11
context: "Created from pressure-testing the schema against the live database (314 MB, 389,715 artifacts) — 12 critical issues that would break or corrupt imports if not addressed. Moved into docs/data-model/ during the 2026-05-11 overhaul. Updated as new issues surface."
status: active
audience: [engineers]
owners: [eric]
related_issues: []
...
# Schema Data Issues & Resolutions
...
**Related docs**: [glintstone-schema.yaml](glintstone-schema.yaml) (schema fixes), [data-quality.md](data-quality.md) (trust architecture), [import-pipeline-guide.md](import-pipeline-guide.md) (validation per step).
...
- Status: Addressed in schema; concordance.py implementation pending
