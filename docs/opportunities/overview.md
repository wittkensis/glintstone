---
question: "TODO: one sentence — what question does overview.md answer?"
created: 2026-05-11
modified: 2026-05-11
...
> **Glintstone status: schema — core architecture designed**
...
> See: `data-model/glintstone-schema.yaml`
...
> **Glintstone status: schema — initial framework designed**
...
> See: `data-model/glintstone-schema.yaml` (ANNOTATION ECOSYSTEM section)
...
> See: `data-model/glintstone-schema.yaml` (KNOWLEDGE GRAPH section)
...
> See: `data-model/glintstone-schema.yaml` (CITATION RESOLUTION section + Layer 0)
