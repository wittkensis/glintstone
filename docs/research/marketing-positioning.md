---
question: "TODO: one sentence — what question does marketing-positioning.md answer?"
created: 2026-05-11
modified: 2026-05-11
...
# Glintstone Marketing Positioning Analysis

**Date:** January 3, 2026
**Prepared by:** Market Positioning Strategist
**Version:** 1.0
**Purpose:** Strategic evaluation of current landing page approach and 5 positioning alternatives
...
1. **Current approach is solid but lacks emotional spark** - The "Decipher 3,000 Years of Human History" tagline and "The Work That Remains" framing are honest and clear, but don't create the curiosity gap that compels exploration.

2. **The 5 proposed approaches offer different value** - Each serves specific positioning goals, but none alone optimizes for the dual audience mandate.

3. **Recommended hybrid strategy**: Combine **Mystery/Discovery (primary hook) + Documentary/Editorial (credibility layer) + Citizen Science (action framework)** for maximum impact.

4. **Core differentiator**: Glintstone is not another academic database or generic crowdsourcing platform - it's the **first genuine pathway for non-experts to contribute to decoding humanity's oldest written archive**, accelerated by AI that makes expert-level work accessible.

---

## 1. Analysis of Current Approach

### Current Wireframe Content (from J1-marketing.html)
...
1. **Honest framing** - No fake stats, no advocacy theater, real problem articulation
2. **Clear value paths** - Three distinct contribution levels reduce intimidation
3. **Trust signals** - Institution badges and expert verification messaging
4. **Low barrier to entry** - "2 minutes" and "No experience needed" directly address hobbyist concerns
5. **Pipeline transparency** - 4-step process demystifies contribution flow

### What's Missing

1. **Emotional hook** - The current approach is informative but not compelling
2. **Curiosity gap** - Nothing makes me desperate to know "what's in these tablets?"
3. **Human connection** - Where are the stories? The ancient voices? The discovery moments?
4. **Differentiation** - Sounds similar to other digital humanities crowdsourcing projects
5. **Why now?** - No urgency or catalyst for action beyond general "help is needed"
...
## 2. Evaluation of Five Alternative Approaches

### Approach 1: Documentary/Editorial (Museum Exhibit Feel)
...
#### Recommended Elements to Borrow
...
### Approach 2: Citizen Science (Zooniverse-Style Participation)
...
### Approach 3: Academic Austere (Minimal, Credibility-Focused)
...
### Approach 4: Progress/Achievement (Visual Gap Visualization)
...
### Approach 5: Mystery/Discovery Hook (Intrigue, Unsolved Questions)
...
### Recommended Headline Evolution
...
**Option A (Discovery Hook):**
"1.2 Million Ancient Voices. Most Never Heard."
- Sub: "You can help us read them - no experience required."

**Option B (Mystery Hook):**
"What Did They Write? 95% of Cuneiform Tablets Have Never Been Read."
- Sub: "Join the effort to decode humanity's oldest archive."

**Option C (Human Connection):**
"4,000-Year-Old Letters. Still Unread."
- Sub: "Help unlock the world's oldest stories - two minutes at a time."

**Option D (Hybrid - RECOMMENDED):**
"Ancient Voices, Waiting to be Heard"
...
### Q1: Which approach(es) best serve the dual audience of academics AND hobbyists?

**Answer: A 60/40 hybrid of Mystery/Discovery + Documentary/Editorial, with Citizen Science mechanics**

**The Formula:**
1. **Hook with mystery** (hobbyist-focused) - "What's in these tablets?" → creates curiosity
2. **Build credibility with editorial framing** (academic-focused) - "This is serious scholarship" → creates trust
3. **Enable action with citizen science mechanics** (both audiences) - "Here's how you contribute" → creates conversion
...
### Q2: What messaging creates "curiosity" without being gimmicky?
...
Create a "Featured Discoveries" section showing 3-5 tablets with:
1. Thumbnail image
2. Brief translated excerpt
3. Why it's surprising/interesting
4. Current status (fully translated / partially translated / unread)
...
### Q3: How do we balance trust/credibility with accessibility?
...
**Visual Metaphor:**
Think of it like a museum exhibit:
1. **Entrance:** Dramatic artifact display (hook)
2. **Context Wall:** Scholarly placard with provenance (credibility)
3. **Interactive Station:** Hands-on contribution (pathway)
...
**The Key Principle:**
Trust comes from **what happens after** they engage, not from badges plastered on the hero section. Hook them first, then prove you're legitimate.
...
Glintstone IS:
**"The first platform that makes expert-level cuneiform scholarship accessible to everyone through AI-assisted contribution pathways - accelerating the work while maintaining academic rigor."**
...
**For Hobbyists:**
"Ever wondered what ancient people wrote about? For the first time, you can actually help decode their tablets - even with zero experience. It's like Duolingo meets archaeological discovery."

**For Learners:**
"The world's first guided pathway from 'curious about cuneiform' to 'contributing real translations.' Learn by doing, with AI assistance that makes expert-level work accessible."

**For Academics:**
"Finally, a way to accelerate the backlog without sacrificing quality. AI-suggested transcriptions + crowd verification + your expert review = 10x faster publication pipeline."
...
2. **"From Your First Task to Published Translation"**
...
### Q5: Provide specific copywriting recommendations for key sections
...
## 5. Visual and Design Recommendations
...
1. **Warm up the palette for accessibility**
...
### Visual Hierarchy for Landing Page

**Above the fold:**
1. Hero headline (largest, serif)
2. Subhead (medium, sans)
3. Primary CTA button (high contrast)
4. Scroll indicator

**Below fold:**
1. Featured tablet showcase (visual hook)
2. Stats (after emotional investment)
3. Three-path contribution cards
4. How it works pipeline
5. Trust signals (institutions, experts)
6. Final CTA

**The Key Principle:**
Lead with discovery and emotion. Prove credibility second. Enable action third.
...
**Position Glintstone as:**
"The bridge between ancient voices and modern ears - where AI makes expert-level scholarship accessible, crowd wisdom accelerates discovery, and every contribution is verified by scholars."

**Core Message:**
"For the first time, you don't have to be an expert to help decode humanity's oldest archive. Start today."
...
2. Select preferred headline approach
3. Draft revised wireframe content
4. Source visual assets (featured tablets, expert testimonials)
5. Implement revised landing page
6. Prepare A/B testing framework
7. Develop ongoing content strategy
