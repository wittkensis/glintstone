...
Usage:
    python 09_import_scholars_directory.py [--reset] [--verify-only] [--db PATH]
"""
...
class ScholarDirectoryImporter:
    ...
    def _import_whos_who(self, conn: sqlite3.Connection) -> int:
    ...
    def _import_wikipedia(self, conn: sqlite3.Connection) -> int:
...
def main():
    ...
    importer = ScholarDirectoryImporter(args.db, reset=args.reset)
