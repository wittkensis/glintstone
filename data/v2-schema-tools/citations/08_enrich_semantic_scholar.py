...
Usage:
    python 08_enrich_semantic_scholar.py [--reset] [--verify-only] [--db PATH]
"""
...
class SemanticScholarEnricher:
    ...
    def _store_citations(self, conn: sqlite3.Connection, pub_id: int, doi: str, data: dict):
...
def main():
    ...
    enricher = SemanticScholarEnricher(args.db, reset=args.reset)
