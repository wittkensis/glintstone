...
git log --oneline -15
git status --short
ls plan/AUDIT-*.md plan/PRD-*.md 2>/dev/null | sort
```

Also read (if present): `plan/AUDIT-2026-06-07-hardening.md`, `plan/AUDIT-2026-06-07-frontend.md`.
...
🟡 **PRD-020: Token Interpretation — decision gate** `plan/PRD-020-token-interpretation-wiring.md` `10m`
